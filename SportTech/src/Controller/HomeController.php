...
class HomeController extends AbstractController
{
     ...
     * @Route("/", name="homep")
     */
    public function base( PaginatorInterface $paginator,CommantaireRepository $commantaireRepository,Request $request,ProduitRepository $produitRepository,PanierRepository $repository): Response
    {
