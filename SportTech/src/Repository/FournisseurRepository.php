...
public function OrderByMail(){
    ...
    $query=$em->createQuery('select f from App\Entity\Fournisseur f order by f.adresse_fournisseur DESC');
        return $query->getResult();
    }

    public function OrderByid(){
        $em=$this->getEntityManager();
        $query=$em->createQuery('select fournisseur from App\Entity\Fournisseur fournisseur order by fournisseur.id DESC');
        return $query->getResult();
    }
}
