...
class Utilisateur implements UserInterface
{
    ...
    /**
     * @ORM\OneToOne(targetEntity=Favorie::class, mappedBy="utilisateur", cascade={"persist", "remove"})
     */
    private $favorie;
    ...
    public function setFavorie(?Favorie $favorie): self
    {
        // unset the owning side of the relation if necessary
        if ($favorie === null && $this->favorie !== null) {
            $this->favorie->setUtilisateur(null);
        }

        // set the owning side of the relation if necessary
        if ($favorie !== null && $favorie->getUtilisateur() !== $this) {
            $favorie->setUtilisateur($this);
        }
