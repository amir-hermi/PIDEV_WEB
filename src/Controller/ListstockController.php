...
class ListstockController extends AbstractController
{
    ...
    public function afficheliststock(): Response
    {
        ...
        return $this->render('liststock/Affiche.html.twig', ['liststock' => $LISTSTOCK , 'CommandeNonlue'=>$this->getDoctrine()->getRepository(Commande::class)->commandeAdmin()]);
    }
    ...
    public function Add(Request $request , ProduitRepository $produitRepository){
        ...
        return $this->render('liststock/Add.html.twig', ['formliststock' =>$form->createView() , 'CommandeNonlue'=>$this->getDoctrine()->getRepository(Commande::class)->commandeAdmin()]);
    }
    /**
    ...
    public function update(CommandestockRepository  $repository,$id,Request $request){
        ...
        return $this->render('liststock/Update.html.twig', ['f' =>$form->createView() , 'CommandeNonlue'=>$this->getDoctrine()->getRepository(Commande::class)->commandeAdmin()]);
    }
